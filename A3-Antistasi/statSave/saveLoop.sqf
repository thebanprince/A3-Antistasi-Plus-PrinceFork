...
["posHQ", [getMarkerPos respawnTeamPlayer,[getDir boxX,getPos boxX],[getDir mapX,getPos mapX],getPos flagX,[getDir vehicleBox,getPos vehicleBox],[getDir traderScreenX,getPos traderScreenX]]] call fn_Savestat;
