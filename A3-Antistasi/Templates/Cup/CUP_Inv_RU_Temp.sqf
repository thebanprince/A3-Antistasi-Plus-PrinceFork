...
CSATMarksman = "CUP_O_RU_Soldier_Marksman_Ratnik_Summer";
staticCrewInvaders = "CUP_O_RU_Soldier_Lite_Ratnik_Summer";
...
//Military Groups
//Teams
groupsCSATSentry = ["CUP_O_RU_Soldier_GL_Ratnik_Summer", "CUP_O_RU_Soldier_Ratnik_Summer"];
groupsCSATSniper = ["CUP_O_RU_Sniper_KSVK_VDV_EMR", "CUP_O_RU_Spotter_VDV_EMR"];
groupsCSATsmall = [groupsCSATSentry, ["CUP_O_RU_Soldier_MG_Ratnik_Summer", "CUP_O_RU_Soldier_AR_Ratnik_Summer"], groupsCSATSniper];
//Fireteams
groupsCSATAA = ["CUP_O_RU_Soldier_TL_Ratnik_Summer", "CUP_O_RU_Soldier_AA_Ratnik_Summer", "CUP_O_RU_Soldier_AA_Ratnik_Summer", "CUP_O_RU_Soldier_AR_Ratnik_Summer"];
groupsCSATAT = ["CUP_O_RU_Soldier_TL_Ratnik_Summer", "CUP_O_RU_Soldier_AT_Ratnik_Summer","CUP_O_RU_Soldier_AT_Ratnik_Summer", "CUP_O_RU_Soldier_A_Ratnik_Summer"];
groupsCSATmid = [["CUP_O_RU_Soldier_TL_Ratnik_Summer","CUP_O_RU_Soldier_MG_Ratnik_Summer","CUP_O_RU_Soldier_AR_Ratnik_Summer","CUP_O_RU_Soldier_AT_Ratnik_Summer"],groupsCSATAA,groupsCSATAT];
//Squads
CSATSquad = ["CUP_O_RU_Soldier_SL_Ratnik_Summer", "CUP_O_RU_Soldier_LAT_Ratnik_Summer", "CUP_O_RU_Soldier_AT_Ratnik_Summer", "CUP_O_RU_Soldier_Marksman_Ratnik_Summer", "CUP_O_RU_Soldier_TL_Ratnik_Summer", "CUP_O_RU_Soldier_MG_Ratnik_Summer", "CUP_O_RU_Soldier_A_Ratnik_Summer", "CUP_O_RU_Soldier_Medic_Ratnik_Summer"];
CSATSpecOp = ["O_R_recon_TL_F", "O_R_recon_JTAC_F", "O_R_recon_GL_F", "O_R_recon_exp_F", "O_R_recon_LAT_F", "O_R_recon_medic_F"];
groupsCSATSquad =
	[
	CSATSquad,
	["CUP_O_RU_Soldier_SL_Ratnik_Summer", "CUP_O_RU_Soldier_LAT_Ratnik_Summer", "CUP_O_RU_Soldier_AT_Ratnik_Summer", "CUP_O_RU_Soldier_Marksman_Ratnik_Summer", "CUP_O_RU_Soldier_AR_Ratnik_Summer", "CUP_O_RU_Soldier_MG_Ratnik_Summer", "CUP_O_RU_Soldier_A_Ratnik_Summer", "CUP_O_RU_Soldier_Medic_Ratnik_Summer"],
	["CUP_O_RU_Soldier_SL_Ratnik_Summer", "CUP_O_RU_Soldier_LAT_Ratnik_Summer", "CUP_O_RU_Soldier_AT_Ratnik_Summer", "CUP_O_RU_Soldier_HAT_Ratnik_Summer", "CUP_O_RU_Soldier_TL_Ratnik_Summer", "CUP_O_RU_Soldier_MG_Ratnik_Summer", "CUP_O_RU_Soldier_A_Ratnik_Summer", "CUP_O_RU_Soldier_Medic_Ratnik_Summer"],
	["CUP_O_RU_Soldier_SL_Ratnik_Summer", "CUP_O_RU_Soldier_LAT_Ratnik_Summer", "CUP_O_RU_Soldier_AT_Ratnik_Summer", "CUP_O_RU_Soldier_Marksman_Ratnik_Summer", "CUP_O_RU_Recon_Marksman_Ratnik_Summer", "CUP_O_RU_Soldier_MG_Ratnik_Summer", "CUP_O_RU_Soldier_A_Ratnik_Summer", "CUP_O_RU_Soldier_Medic_Ratnik_Summer"]
	];
