...
SDKSniper = ["CUP_I_GUE_Sniper","CUP_I_RACS_Sniper_wdl"];
SDKATman = ["CUP_I_GUE_Soldier_AT", "CUP_I_RACS_Soldier_MAT_wdl"];
SDKMedic = ["CUP_I_GUE_Medic","CUP_I_RACS_Medic_wdl"];
SDKMG = ["CUP_I_GUE_Soldier_AR","CUP_I_RACS_AR_wdl"];
SDKExp = ["CUP_I_GUE_Saboteur","I_Soldier_exp_F"];
SDKGL = ["CUP_I_GUE_Soldier_GL","CUP_I_RACS_GL_wdl"];
SDKMil = ["CUP_I_GUE_Soldier_AKSU","CUP_I_RACS_Soldier_Light_wdl"];
SDKSL = ["CUP_I_GUE_Officer","CUP_I_RACS_SL_wdl"];
SDKEng = ["CUP_I_GUE_Engineer","CUP_I_RACS_Engineer_wdl"];
