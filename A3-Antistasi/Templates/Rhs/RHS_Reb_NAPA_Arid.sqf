...
vehSDKFuel = "rhsgref_cdf_ural_fuel";
...
initialRebelEquipment append ["rhs_sidor"];
initialRebelEquipment append ["V_BandollierB_blk", "V_BandollierB_rgr", "V_BandollierB_oli", "V_Rangemaster_belt", "rhs_vest_pistol_holster","rhs_vest_commander","rhs_6sh46"];
initialRebelEquipment append ["rhs_acc_2dpZenit","Binocular", "Laserbatteries"];
//Greenfor uniforms
allRebelUniforms append ["U_IG_Guerilla1_1",
    "U_IG_Guerilla2_1",
    "U_IG_Guerilla2_2",
    "U_IG_Guerilla2_3",
    "U_IG_Guerilla3_1",
