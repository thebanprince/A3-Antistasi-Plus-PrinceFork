...
//Squads
NATOSquadT1 = ["B_soldier_SL_F",NATOGrunt select 0,"B_soldier_LAT_F",NATOMarksman,"B_soldier_TL_F","B_soldier_AR_F","B_soldier_A_F","B_medic_F"];
NATOSquadT2 = ["B_soldier_SL_F",NATOGrunt select 0,"B_soldier_LAT_F",NATOMarksman,"B_soldier_TL_F","B_soldier_AR_F","B_soldier_A_F","B_medic_F"];
NATOSquadT3 = ["B_soldier_SL_F",NATOGrunt select 0,"B_soldier_LAT_F",NATOMarksman,"B_soldier_TL_F","B_soldier_AR_F","B_soldier_A_F","B_medic_F"];
