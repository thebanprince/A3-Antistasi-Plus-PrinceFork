...
["vehiclesTrucks", ["O_T_Truck_02_F", "O_T_Truck_02_transport_F"]] call _fnc_saveToTemplate; 			
["vehiclesCargoTrucks", ["O_T_Truck_02_flatbed_F", "O_T_Truck_02_cargo_F"]] call _fnc_saveToTemplate; 		
["vehiclesAmmoTrucks", ["O_T_Truck_02_Ammo_F", "O_T_Truck_03_ammo_ghex_F"]] call _fnc_saveToTemplate; 		
...
["vehiclesMedical", ["CUP_O_BMP2_AMB_CSAT_T","O_T_Truck_03_medical_ghex_F", "O_T_Truck_02_Medical_F"]] call _fnc_saveToTemplate;			
["vehiclesAPCs", ["CUP_O_BMP1_CSAT_T", "CUP_O_BMP1P_CSAT_T", "CUP_O_BMP2_CSAT_T", "CUP_O_BMP2_ZU_CSAT_T", "CUP_O_BMP3_CSAT_T", "CUP_O_BTR80_CSAT_T", "CUP_O_BTR80A_CSAT_T", "O_T_APC_Tracked_02_cannon_ghex_F", "O_T_APC_Wheeled_02_rcws_v2_ghex_F"]] call _fnc_saveToTemplate; 				
["vehiclesTanks", ["CUP_O_T72_CSAT_T", "O_T_MBT_04_command_F", "O_T_MBT_04_cannon_F", "O_T_MBT_02_cannon_ghex_F"]] call _fnc_saveToTemplate; 			
...
["vehiclesAmphibious", ["CUP_O_BMP3_CSAT_T"]] call _fnc_saveToTemplate; 		

["vehiclesPlanesCAS", ["CUP_O_Su25_Dyn_CSAT_T"]] call _fnc_saveToTemplate; 		
...
["vehiclesHelisLight", ["O_T_Heli_Transport_04_bench_F", "O_T_Heli_Light_02_unarmed_F"]] call _fnc_saveToTemplate; 		
["vehiclesHelisTransport", ["O_T_Heli_Transport_04_bench_F", "O_T_Heli_Transport_04_covered_F", "O_T_Heli_Light_02_unarmed_F"]] call _fnc_saveToTemplate; 	
...
_loadoutData setVariable ["ATLaunchers", ["CUP_launch_RShG2", "CUP_launch_RPG26"]]; 				
...
_militaryLoadoutData setVariable ["uniforms", ["Atlas_U_O_W_CombatUniform_owcamo"]];		
_militaryLoadoutData setVariable ["offuniforms", ["Atlas_U_O_W_OfficerUniform"]];
_militaryLoadoutData setVariable ["vests", ["V_HarnessOSpec_whex_F", "V_TacVest_oli"]];			
_militaryLoadoutData setVariable ["GLvests", ["V_HarnessOGL_whex_F"]];
_militaryLoadoutData setVariable ["Hvests", []];
_militaryLoadoutData setVariable ["backpacks", ["B_Carryall_owcamo", "B_FieldPack_owcamo"]];		
_militaryLoadoutData setVariable ["helmets", ["H_HelmetO_whex_F", "H_HelmetSpecO_whex_F"]];		
...
_militiaLoadoutData setVariable ["uniforms", ["Atlas_U_O_officer_noInsignia_whex_F"]];		
...
_militiaLoadoutData setVariable ["backpacks", ["B_FieldPack_ghex_F", "B_Carryall_owcamo"]];		
...
_eliteLoadoutData setVariable ["uniforms", ["Atlas_U_O_W_CombatUniform_owcamo"]];		
_eliteLoadoutData setVariable ["offuniforms", ["Atlas_U_O_W_OfficerUniform"]];
_eliteLoadoutData setVariable ["vests", ["V_PlateCarrier1_oli"]];			
_eliteLoadoutData setVariable ["GLvests", ["V_PlateCarrier2_oli"]];
_eliteLoadoutData setVariable ["Hvests", ["V_PlateCarrier2_oli"]];
_eliteLoadoutData setVariable ["backpacks", ["B_Carryall_owcamo"]];					
_eliteLoadoutData setVariable ["helmets", ["H_HelmetLeaderO_whex_F", "H_HelmetSpecO_whex_F"]];		
