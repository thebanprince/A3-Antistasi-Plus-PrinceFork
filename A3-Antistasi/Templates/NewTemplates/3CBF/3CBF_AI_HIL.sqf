...
_loadoutData setVariable ["antiInfantryGrenades", ["rhs_mag_m67", "rhs_grenade_mkii_mag"]]; 		//this line determines anti infantry grenades (frag and such) -- Example: ["HandGrenade", "MiniGrenade"] -- Array, can contain multiple assets
