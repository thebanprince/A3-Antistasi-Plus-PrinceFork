...
A3A_logistics_attachmentOffset append [
    ...
    ["CUP_B_M2StaticMG_USMC" call A3A_fnc_classNameToModel,                     [0.35, -0.5, 1.1],          [0, 1, 0],                  2,      100],               //M2HB machinegun
    ["CUP_B_SearchLight_static_USMC" call A3A_fnc_classNameToModel,             [0, -0.1, 0.15],            [0, 1, 0],                  2,      100],               //M2HB machinegun
    ["CUP_O_KORD_high_RU" call A3A_fnc_classNameToModel,                        [0, -0.1, 1.1],             [0, 1, 0],                  2,      100],               //M2HB machinegun
    ["CUP_B_M2StaticMG_MiniTripod_USMC" call A3A_fnc_classNameToModel,          [0.3, -0.5, 0.95],          [0, 0, 0],                  2,      100],            //M2HB sitting machinegun
    ["CUP_B_DSHkM_MiniTriPod_CDF" call A3A_fnc_classNameToModel,                [-0.15, 0.3, 1.35],          [0, -1, 0],                  2,      100],            //M2HB sitting machinegun
    ["CUP_O_KORD_RU" call A3A_fnc_classNameToModel,                             [0, -0.20, 1.1],            [0, -1, 0],                  2,      100],            //M2HB sitting machinegun
    ["CUP_B_MK19_TriPod_USMC" call A3A_fnc_classNameToModel,                    [0, 0.3, 1.05],            [0, -1, 0],                 2,      100],        
    ["CUP_B_AGS_CDF" call A3A_fnc_classNameToModel,                             [0, 0.3, 1.07],             [0, -1, 0],                 2,      100],       
    ["CUP_O_Metis_RU" call A3A_fnc_classNameToModel,                            [0, 0.3, 1.13],            [0, -1, 0],                 2,      100],  
    ["CUP_O_SPG9_ChDKZ" call A3A_fnc_classNameToModel,                          [0, -0.5, 0.1],            [0, -1, 0],                 2,      100],     
    ["CUP_O_Kornet_RU" call A3A_fnc_classNameToModel,                           [0, -0.7, 0.77],            [0, 0, 0],                 2,      100],       
    ["CUP_B_DSHKM_ACR" call A3A_fnc_classNameToModel,                           [0.3, -0.5, 1.65],          [0, 1, 0],                  2,      100],             //DShKM
    ["CUP_B_ZU23_CDF" call A3A_fnc_classNameToModel,                            [-0.1,0,2],                 [0, 1, 0],                  2,      750],              //ZU-23
    ["CUP_B_Igla_AA_pod_CDF" call A3A_fnc_classNameToModel,                     [0.25,0.5,1.65],                  [0, 1, 0],                  2,      250],
    ["CUP_B_2b14_82mm_ACR" call A3A_fnc_classNameToModel,                       [0, -0.55, 0.85],            [0, 1, 0],                  2,      2000],              //Podnos Mortar
    ["CUP_B_M252_USMC" call A3A_fnc_classNameToModel,                           [0, -0.55, 0.85],            [0, 1, 0],                  2,      2000],              //Podnos Mortar
//Crates
//Other
