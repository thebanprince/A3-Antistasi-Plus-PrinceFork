...
vehNATOCargoTrucks = ["B_E_Truck_01_cargo_F", "B_E_Truck_01_flatbed_F"];
...
vehNATOAttack = vehNATOAPC + ["B_W_AFV_Wheeled_01_cannon_F", "B_W_AFV_Wheeled_01_up_cannon_F", vehNATOTank];
//Boats
