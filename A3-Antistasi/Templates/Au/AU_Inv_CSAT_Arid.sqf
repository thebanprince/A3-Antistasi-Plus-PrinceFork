...
groupsCSATsmall = [groupsCSATSentry,["O_recon_M_F","O_recon_F"], ["O_Soldier_CQ_F", "O_Soldier_lite_F"], groupsCSATSniper];
//Fireteams
...
groupsCSATSquad =
	...
	["O_Soldier_SL_F","O_Soldier_AR_F","O_Soldier_GL_F","O_Sharpshooter_F","O_Soldier_AT_F","O_Soldier_AAT_F","O_Soldier_A_F","O_medic_F"],
...
vehCSATLightArmed = ["O_MRAP_02_hmg_F", "O_MRAP_02_gmg_F", "O_LSV_02_AT_F", "O_LSV_02_armed_F", "CUP_O_BRDM2_CSAT","CUP_O_BRDM2_HQ_CSAT", "CUP_O_BRDM2_ATGM_CSAT", "CUP_O_ZSU23_Afghan_CSAT"];
...
//Armored
vehCSATAPC = ["O_APC_Wheeled_02_rcws_v2_F","O_APC_Tracked_02_cannon_F", "CUP_O_BMP1_CSAT","CUP_O_BMP1P_CSAT","CUP_O_BMP2_CSAT","CUP_O_BMP2_ZU_CSAT","CUP_O_BTR60_CSAT","CUP_O_BTR80_CSAT","CUP_O_BTR80A_CSAT"];
vehCSATTanks = ["O_MBT_02_cannon_F", "CUP_O_T72_CSAT", "O_MBT_04_command_F", "O_MBT_04_cannon_F"];
...
//Planes
vehCSATPlane = "CUP_O_SU34_CSAT";
vehCSATPlaneAA = "O_Plane_Fighter_02_F";
vehCSATTransportPlanes = ["O_T_VTOL_02_infantry_F", "O_Plane_Transport_01_infantry_F"];
//Heli
vehCSATPatrolHeli = "O_Heli_Light_02_unarmed_F";
vehCSATTransportHelis = ["O_Heli_Transport_04_bench_F",vehCSATPatrolHeli, "CUP_O_Ka60_GL_Hex_CSAT", "CUP_O_Ka60_GL_Blk_CSAT", "O_Heli_Transport_04_covered_F"];
vehCSATAttackHelis = ["O_Heli_Attack_02_dynamicLoadout_F", "O_VTOL_02_infantry_dynamicLoadout_F"];
//UAV
