...
if (_remainingBases < 2) then {
    if (_sideX == Invaders) then {
        ...
        private _text = format [
            "<t size='0.6'><t size='0.6' color='#800000'>%1</t> has been surrendered to us. Their aircraft carrier will leave the surrounding sea, they will no longer launch any attack on us. Congratulations!</t>", 
            nameInvaders
        ];
    ...
    if (_sideX == Occupants) then {
        ...
        private _text = format [
            "<t size='0.6'><t size='0.6' color='#004d99'>%1</t> has been surrendered to us. Their aircraft carrier will leave the surrounding sea and they will no longer launch any attack on us. Congratulations!</t>", 
            nameOccupants
        ];
        [petros, "announce", _text] remoteExec ["A3A_fnc_commsMP", 0];
    };
