...
if ([_typeX] call BIS_fnc_taskExists) exitWith {if (!_silencio) then {[petros,"globalChat",localize "STR_antistasi_missions_info_missionRequest_mission_text_1"] remoteExec ["A3A_fnc_commsMP",theBoss]}};
...
if (_typeX == "AS") then
	...
	if (count _potentials == 0) then
		...
		if (!_silencio) then
			{
			[petros,"globalChat",localize "STR_antistasi_missions_info_missionRequest_mission_text_2"] remoteExec ["A3A_fnc_commsMP",theBoss];
			[petros,"hint",localize "STR_antistasi_missions_info_missionRequest_mission_text_3"] remoteExec ["A3A_fnc_commsMP",theBoss];
			};
		}
	else
		{
...
if (_typeX == "CON") then
	...
	if (count _potentials == 0) then
		...
		if (!_silencio) then
			{
			[petros,"globalChat",localize "STR_antistasi_missions_info_missionRequest_mission_text_4"] remoteExec ["A3A_fnc_commsMP",theBoss];
			[petros,"hint",localize "STR_antistasi_missions_info_missionRequest_mission_text_5"] remoteExec ["A3A_fnc_commsMP",theBoss];
			};
		}
	else
		{
...
if (_typeX == "DES") then
	...
	if (count _potentials == 0) then
		...
		if (!_silencio) then
			{
			[petros,"globalChat",localize "STR_antistasi_missions_info_missionRequest_mission_text_6"] remoteExec ["A3A_fnc_commsMP",theBoss];
			[petros,"hint",localize "STR_antistasi_missions_info_missionRequest_mission_text_7"] remoteExec ["A3A_fnc_commsMP",theBoss];
			};
		}
	else
		{
...
if (_typeX == "LOG") then
	...
	if (count _potentials == 0) then
		...
		if (!_silencio) then
			{
			[petros,"globalChat",localize "STR_antistasi_missions_info_missionRequest_mission_text_8"] remoteExec ["A3A_fnc_commsMP",theBoss];
			[petros,"hint",localize "STR_antistasi_missions_info_missionRequest_mission_text_9"] remoteExec ["A3A_fnc_commsMP",theBoss];
			};
		}
	else
		{
...
if (_typeX == "RES") then
	...
	if (count _potentials == 0) then
		...
		if (!_silencio) then
			{
			[petros,"globalChat",localize "STR_antistasi_missions_info_missionRequest_mission_text_10"] remoteExec ["A3A_fnc_commsMP",theBoss];
			[petros,"hint",localize "STR_antistasi_missions_info_missionRequest_mission_text_11"] remoteExec ["A3A_fnc_commsMP",theBoss];
			};
		}
	else
		{
...
if (_typeX == "CONVOY") then
	...
	if (!bigAttackInProgress) then
		...
		if (count _potentials == 0) then
			...
			if (!_silencio) then
				{
				[petros,"globalChat",localize "STR_antistasi_missions_info_missionRequest_mission_text_12"] remoteExec ["A3A_fnc_commsMP",theBoss];
				[petros,"hint",localize "STR_antistasi_missions_info_missionRequest_mission_text_13"] remoteExec ["A3A_fnc_commsMP",theBoss];
				};
			}
		else
			{
		...
		{
		[petros,"globalChat",localize "STR_antistasi_missions_info_missionRequest_mission_text_14"] remoteExec ["A3A_fnc_commsMP",theBoss];
		[petros,"hint",localize "STR_antistasi_missions_info_missionRequest_mission_text_15"] remoteExec ["A3A_fnc_commsMP",theBoss];
		};
	};

if ((count _potentials > 0) and (!_silencio)) then {[petros,"globalChat", localize "STR_antistasi_missions_info_missionRequest_mission_text_16"] remoteExec ["A3A_fnc_commsMP",theBoss]};
