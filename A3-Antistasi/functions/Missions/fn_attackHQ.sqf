...
[[teamPlayer,civilian],"DEF_HQ",[format [localize "STR_antistasi_missions_info_attackHQ_mission_text_1",name petros],format [localize "STR_antistasi_missions_info_attackHQ_task_name_1",name petros],respawnTeamPlayer],_positionX,true,10,true,"Defend",true] call BIS_fnc_taskCreate;
[[_sideX],"DEF_HQ1",[format [localize "STR_antistasi_missions_info_attackHQ_mission_text_2",name petros, nameTeamPlayer],format [localize "STR_antistasi_missions_info_attackHQ_task_name_2",name petros],respawnTeamPlayer],_positionX,true,10,true,"Attack",true] call BIS_fnc_taskCreate;
...
if (!alive petros) then
	{
	["DEF_HQ",[format [localize "STR_antistasi_missions_info_attackHQ_mission_text_1",name petros],format [localize "STR_antistasi_missions_info_attackHQ_task_name_1",name petros],respawnTeamPlayer],_positionX,"FAILED"] call A3A_fnc_taskUpdate;
	["DEF_HQ1",[format [localize "STR_antistasi_missions_info_attackHQ_mission_text_2",name petros,nameTeamPlayer],format [localize "STR_antistasi_missions_info_attackHQ_task_name_2",name petros],respawnTeamPlayer],_positionX,"SUCCEEDED"] call A3A_fnc_taskUpdate;
	}
else
	{
	if (_positionX distance getMarkerPos respawnTeamPlayer > 999) then
		{
		["DEF_HQ",[format [localize "STR_antistasi_missions_info_attackHQ_mission_text_1",name petros],format [localize "STR_antistasi_missions_info_attackHQ_task_name_1",name petros],respawnTeamPlayer],_positionX,"SUCCEEDED"] call A3A_fnc_taskUpdate;
		["DEF_HQ1",[_sideX],[format [localize "STR_antistasi_missions_info_attackHQ_mission_text_2",name petros,nameTeamPlayer],format [localize "STR_antistasi_missions_info_attackHQ_task_name_2",name petros],respawnTeamPlayer],_positionX,"FAILED"] call A3A_fnc_taskUpdate;
		}
	else
		{
		["DEF_HQ",[format [localize "STR_antistasi_missions_info_attackHQ_mission_text_1",name petros],format [localize "STR_antistasi_missions_info_attackHQ_task_name_1",name petros],respawnTeamPlayer],_positionX,"SUCCEEDED"] call A3A_fnc_taskUpdate;
		["DEF_HQ1",[format [localize "STR_antistasi_missions_info_attackHQ_mission_text_2",name petros,nameTeamPlayer],format [localize "STR_antistasi_missions_info_attackHQ_task_name_2",name petros],respawnTeamPlayer],_positionX,"FAILED"] call A3A_fnc_taskUpdate;
