...
[[teamPlayer,civilian],"LOG",[format [localize "STR_antistasi_missions_info_LOG_Ammo_mission_text_1.",_nameDest,_displayTime],localize "STR_antistasi_missions_info_LOG_Ammo_task_name_1",_markerX],_pos,false,0,true,"rearm",true] call BIS_fnc_taskCreate;
_truckCreated = false;
...
if ((spawner getVariable _markerX != 2) and !(sidesX getVariable [_markerX,sideUnknown] == teamPlayer)) then
	...
	if (dateToNumber date > _dateLimitNum) then
		{
		["LOG",[format [localize "STR_antistasi_missions_info_LOG_Ammo_mission_text_1.",_nameDest,_displayTime],localize "STR_antistasi_missions_info_LOG_Ammo_task_name_1",_markerX],_positionX,"FAILED","rearm"] call A3A_fnc_taskUpdate;
	...
	if ((not alive _truckX) or (call _fnc_truckReturnedToBase)) then
		{
			...
			["LOG",[format [localize "STR_antistasi_missions_info_LOG_Ammo_mission_text_1.",_nameDest,_displayTime],localize "STR_antistasi_missions_info_LOG_Ammo_task_name_1",_markerX],_positionX,"SUCCEEDED","rearm"] call A3A_fnc_taskUpdate;
