...
[[teamPlayer,civilian],"AS",[format [localize "STR_antistasi_missions_info_AS_Traitor_mission_text_1",_nameDest,_displayTime,nameOccupants],localize "STR_antistasi_missions_info_AS_Traitor_task_name_1",_markerX],_posTsk,false,0,true,"Kill",true] call BIS_fnc_taskCreate;
[[Occupants],"AS1",[format [localize "STR_antistasi_missions_info_AS_Traitor_mission_text_2",_nameDest,_displayTime,nameTeamPlayer],localize "STR_antistasi_missions_info_AS_Traitor_task_name_2",_markerX],getPos _houseX,false,0,true,"Defend",true] call BIS_fnc_taskCreate;
...
if (not alive _traitor) then
	{
	["AS",[format [localize "STR_antistasi_missions_info_AS_Traitor_mission_text_1",_nameDest,_displayTime,nameOccupants],localize "STR_antistasi_missions_info_AS_Traitor_task_name_1",_markerX],_traitor,"SUCCEEDED"] call A3A_fnc_taskUpdate;
	["AS1",[format [localize "STR_antistasi_missions_info_AS_Traitor_mission_text_2",_nameDest,_displayTime,nameTeamPlayer],localize "STR_antistasi_missions_info_AS_Traitor_task_name_2",_markerX],getPos _houseX,"FAILED"] call A3A_fnc_taskUpdate;
	if (_difficultX) then
		{
	...
	{
	["AS",[format [localize "STR_antistasi_missions_info_AS_Traitor_mission_text_1",_nameDest,_displayTime,nameOccupants],localize "STR_antistasi_missions_info_AS_Traitor_task_name_1",_markerX],_traitor,"FAILED"] call A3A_fnc_taskUpdate;
	["AS1",[format [localize "STR_antistasi_missions_info_AS_Traitor_mission_text_2",_nameDest,_displayTime,nameTeamPlayer],localize "STR_antistasi_missions_info_AS_Traitor_task_name_2",_markerX],getPos _houseX,"SUCCEEDED"] call A3A_fnc_taskUpdate;
