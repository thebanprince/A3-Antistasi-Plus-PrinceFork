...
switch (toLower worldName) do {
	...
	case "blud_vidda": {
	    _posAntennas = [[1016.07,3022.08,0],[11360.8,3840.86,0],[5352.11,2864.58,0],[7091.22,11366.6,0],[2229.25,7307.28,0],[11484.7,10539,0],[6321.78,6405.23,0],[9586.24,8275.53,0]];
