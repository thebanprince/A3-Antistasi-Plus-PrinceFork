...
switch _typeX do
{
    ...
    case "mission":
    {
        petros addAction ["Access Black Market", {call SCRT_fnc_shop_checkAvailability},nil,0,false,true,"","(isPlayer _this) and (_this == _this getVariable ['owner',objNull]) and ([_this] call A3A_fnc_isMember) and (petros == leader group petros)", 4]; 
    ...
    case "seaport":
    {
        ...
        _flag addAction ["Access Black Market", {call SCRT_fnc_shop_checkAvailability},nil,0,false,true,"","(isPlayer _this) and (_this == _this getVariable ['owner',objNull])",4];
    };
    case "steal":
    {
